  ...
  return (
    <div className="px-3 sm:px-4 lg:px-6 py-4 space-y-4">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <button onClick={load} className="ml-auto text-gray-400 hover:text-gray-600 p-1.5" title="Refresh">
          <RefreshCw size={17} />
        </button>
      </div>
                  ...
                  return (
                    <div key={w.waiterId ?? w.waiterName} className="px-4 py-3">
                      ...
                      <div className="ml-9 mt-1 flex items-center gap-3">
                        ...
                        {w.orderCount > 0 && (
                          <p className="text-xs text-gray-400">{Math.round((w.servedCount / w.orderCount) * 100)}% completion</p>
                        )}
                        {w.avgServeMins > 0 && (
